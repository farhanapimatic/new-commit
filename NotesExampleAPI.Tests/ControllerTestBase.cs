...
using NotesExampleAPI.PCL.Models;
...
namespace NotesExampleAPI.Tests
{
    ...
    public class ControllerTestBase
    {
        ...
        private static NotesExampleAPIClient client;
        ...
        /// </summary>
        /// <returns></returns>
        public static NotesExampleAPIClient GetClient()
        {
            lock (clientSync)
            {
                if (client == null)
                {
                    client = new NotesExampleAPIClient();
                }
                return client;
            }
        }
